import { faAmericanSignLanguageInterpreting, faArrowRight, faEarthAmerica, faFlagUsa } from "@fortawesome/free-solid-svg-icons";
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import {faFacebook, faInstagram, faXTwitter, faPinterest, faTiktok} from "@fortawesome/free-brands-svg-icons";
  ...
  return (
    <div>
      ...
      <div className="bg-yellow-400 text-black font-sans flex justify-center gap-3 items-center py-3">
        <h1 className="text-[12px] font-bold md:text-[20px]">JOIN OUR CLUB & GET 15% OFF</h1>
      ...
      <div className="flex justify-evenly w-screen px-2 gap-2 py-3">
        <div className="w-[calc(100vw/3)] md:w-[calc(100vw/4)] ps-3 ">
          <h1 className=" font-semibold font-sans text-[15px] md:text-[20px]">PRODUCTS</h1>
        ...
        <div className="w-[calc(100vw/3)] md:w-[calc(100vw/4)] ps-3 ">
          <h1 className=" font-semibold font-sans text-[15px] md:text-[20px]">SUPPORT</h1>
          <ul className="text-[13px] font-sans md:text-[16px] space-y-2 py-2">
            <li>Help</li>
            <li>Return Policy</li>
            <li>Shipping</li>
        ...
        <div className="md:w-[calc(100vw/4)] ps-3 hidden md:block">
          <h1 className=" font-semibold font-sans text-[15px] md:text-[20px]">COMPANY INFO</h1>
          <ul className="text-[13px] font-sans md:text-[16px] space-y-2 py-2">
            <li>About Us</li>
            <li>Discount</li>
            <li>Careers</li>
        ...
        <div className="w-[calc(100vw/3)] md:w-[calc(100vw/4)] ps-3 ">
          <h1 className=" font-semibold font-sans text-[15px] md:text-[20px]">FOLLOW US</h1>
          <ul className="text-[13px] font-sans md:text-[16px] space-y-2 py-2">
            <li className="flex items-center gap-2">
              <FontAwesomeIcon className="text-[15px] md:text-[20px]" icon={faFacebook}/>
              Nike Official
            </li>
            <li className="flex items-center gap-2">
              <FontAwesomeIcon className="text-[15px] md:text-[20px]" icon={faInstagram}/>
              Nike_us_official
            </li>
            <li className="flex items-center gap-2">
              <FontAwesomeIcon className="text-[15px] md:text-[20px]" icon={faXTwitter}/>
              Nike@us
            </li>
            <li className="flex items-center gap-2">
              <FontAwesomeIcon className="text-[15px] md:text-[20px]" icon={faPinterest}/>
              USA-Nike
            </li>
            <li className="flex items-center gap-2">
              <FontAwesomeIcon className="text-[15px] md:text-[20px]" icon={faTiktok}/>
              Nike USA
            </li>
          </ul>
        </div>
      ...
      <div className="bg-black/80 text-white flex flex-col justify-center items-center gap-4 py-4">
        <span className="md:text-[20px]"><FontAwesomeIcon icon={faEarthAmerica}/> United States</span>
        <div className="flex justify-evenly text-[12px] w-screen md:text-[16px]">
          <span>Customer Service</span>
          <span>Privacy Policy</span>
          <span>Terms and Conditions</span>
        </div>
        <span className="text-[12px] md:text-[15px]"> &copy; 2025 Nike. All rights reserved.</span>
      </div>
    </div>
  );
};
