...
const Login = () => {
  ...
  return (
    <div
      className="w-screen h-[750px] flex justify-center items-center bg-center bg-cover"
      ...
      <div className="flex items-center justify-between border-[3px] border-violet-500 md:border-none w-[90%] lg:w-[55%] px-6 h-[65%] lg:h-[70%] md:h-[70%] rounded-xl bg-white">
        ...
        <div className="md:border-2 border-blue-500 rounded-xl md:w-[51%] w-full h-[90%] flex flex-col gap-2 justify-center items-center">
          ...
          <div className="bg-gray-300/50 px-2 py-[20px] rounded text-[16px] w-[90%] md:w-3/4 mt-3 relative">
            <input
              className="absolute input1 w-full focus:border-none focus:outline-none z-10 top-2"
              type="text"
            />
            <span className="span1 absolute top-2 left-2 text-gray-600/90 z-0 text-[16px]">
              Email address
            </span>
          </div>
          <div className="bg-gray-300/50 px-2 py-[20px] rounded text-[16px] w-[90%] md:w-3/4 mt-2 relative">
            <input
              className="absolute input2 w-full focus:border-none focus:outline-none z-10 top-2"
              type={showPassword ? "text" : "password"}
            />
            <span className="span2 absolute top-2 left-2 text-gray-600/90 z-0 text-[16px]">
              Password
            </span>
            <FontAwesomeIcon
          ...
          <Link
            to="/"
            type="submit"
            className="bg-blue-500 active:bg-blue-500/80 rounded-md text-white md:w-3/4 py-2 text-[16px] mt-2 text-center w-[90%]"
          >
            Login
          </Link>
          <div className="relative border-t-[1px] border-black w-3/5 mt-4">
            <span className="bg-white px-2 py-1 absolute top-[-14px] right-[30%] text-[12px]">
              Or Login With
            </span>
          </div>
